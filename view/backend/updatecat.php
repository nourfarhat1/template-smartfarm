...
if (isset($_POST['newCategoryName']) && isset($_POST['oldCategoryName'])) {
    ...
    if ($result) {
        echo "<script>alert('Category updated successfully!'); window.location.href='listcat.php';</script>";
    } else {
...
<main class="container my-5">
    <div class="card p-4">
        ...
        <?php endif; ?>
        <form id="categoryForm" action="updatecat.php" method="POST" onsubmit="return validateForm()">

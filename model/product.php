...
class Product
{
    ...
    public function filterProductsByCategory($categoryName, $minPrice, $maxPrice) {
        $sql = "SELECT * FROM products WHERE nomcategorie = :nomcategorie AND priceprod BETWEEN :minPrice AND :maxPrice";
        
        // Add date filtering if dates are provided
        if ($startDate && $endDate) {
            $sql .= " AND created_at BETWEEN :startDate AND :endDate"; // Assuming you have a created_at column
        }
